...
const Home = () => {
    return (
        <>
            ...
            <Helmet>
                <meta charSet='utf-8' />
                <title>Home | Precision Farming Model - Group 175</title>
            </Helmet>

            {/* Hero Section */}
            <section className='bg-green-80 min-h-screen animate-fadeIn duration-500'>
                <div className='flex flex-col xl:pt-52 lg:pt-44 md:pt-32 sm:pt-20 pt-16 justify-end relative min-h-screen'>
                    ...
                    <img
                        className='absolute inset-x-0 animate-bounceIn  duration-500 delay-500'
                        src={produce}
                        alt='Leaf'
                    />
