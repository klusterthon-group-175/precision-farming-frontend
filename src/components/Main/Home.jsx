    ...
    return (
        <section className='bg-green-80 min-h-screen'>
            <div className='flex flex-col xl:pt-52 lg:pt-44 md:pt-32 sm:pt-20 pt-16 justify-end relative min-h-screen'>
                ...
                <div
                    className='text-center relative xl:pt-[101px] xl:pb-[282px] lg:py-40 md:py-28 sm:py-20 py-5   bg-cover bg-no-repeat'
                    // style={{ backgroundImage: `url(${produce})` }}
                >
                    ...
                    <Link
                        to='/'
                        className='bg-white text-green-850 font-semibold md:text-2xl sm:text-xl leading-normal px-6 py-3 rounded-lg border border-white sm:mt-10 mt-5 inline-block'>
