...
const Results = () => {
    return (
        <>
            ...
            <Helmet>
                <meta charSet='utf-8' />
                <title>Predictions | Precision Farming Model - Group 175</title>
            </Helmet>

            {/* Main Section */}
            <section
                className='bg-no-repeat text-center animate-fadeIn duration-500 sm:py-0 py-5 bg-center min-h-screen flex justify-center items-center bg-white text-neutral-gray-900'
                style={{
                    backgroundImage: `url(${field})`,
                }}>
                <article className='bg-white animate-slideIn duration-500 delay-700 p-6 rounded-xl border border-green-350 shadow-modal sm:max-w-md max-w-[90%]'>
